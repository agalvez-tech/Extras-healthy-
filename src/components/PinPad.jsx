  ...
  return (
    <div className="screen">
      <div className="pin-wrap">
        {eyebrow && (
          <div style={{ color: 'var(--gold)', letterSpacing: 1.5, fontSize: 12, textTransform: 'uppercase', marginBottom: 6 }}>
            {eyebrow}
          </div>
        )}
        ...
        <button className="link-btn" style={{ marginTop: 12 }} onClick={onBack}>← Volver</button>
      </div>
    </div>
  )
}
